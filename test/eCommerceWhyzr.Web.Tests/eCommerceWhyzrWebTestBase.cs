...
{
    public abstract class eCommerceWhyzrWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eCommerceWhyzrWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eCommerceWhyzrWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eCommerceWhyzrDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eCommerceWhyzrDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eCommerceWhyzrDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eCommerceWhyzrDbContext, Task<T>> func)
        {
            T result;
