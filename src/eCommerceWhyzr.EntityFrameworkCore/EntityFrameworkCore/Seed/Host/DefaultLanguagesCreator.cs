...
namespace eCommerceWhyzr.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = eCommerceWhyzrConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(eCommerceWhyzrDbContext context)
        {
            _context = context;
        }
